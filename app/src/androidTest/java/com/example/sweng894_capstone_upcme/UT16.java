...
/**
 * Used to validate that the Product Title control is displayed in the UI when a specific product is scanned.
 */
public class UT16
{
    @Rule
    ...
    public void ut16() throws InterruptedException
    {
        mActivityScenarioRule.getScenario().onActivity(activity ->
        {
            activity.runOnUiThread(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    //that is not contained in the Barcode Lookup API which will not return a product title.
                    //When a barcode is not found, the UI will clear.
        ...
        onView(withId(R.id.tv_ProductTitleTextView)).check(matches(withText("")));
        ...
        Thread.sleep(2000);
        onView(withId(R.id.tv_ProductTitleTextView)).check(matches(not(withText(""))));
    }
