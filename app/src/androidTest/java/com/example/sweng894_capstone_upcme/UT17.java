...
/**
 * Used to validate that the Product Description control is displayed in the UI when a specific product is scanned.
 */
public class UT17
{
    @Rule
    ...
    public void ut17() throws InterruptedException
    {
        ...
        onView(withId(R.id.tv_ProductDescriptionTextView)).check(matches(withText("")));
        ...
        onView(withId(R.id.tv_ProductDescriptionTextView)).check(matches(not(withText(""))));
    }
